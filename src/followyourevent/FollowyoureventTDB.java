...
public class FollowyoureventTDB {
 	...
 	public static void main(String[] args) {
		ArrayList<String> arr = FollowyoureventTDB.getFollowyoureventTDB().getInformationAboutAPerson("maildecade@gmail.com");
	...
	/*public Resource getResource(String mail){
	...
	*/
	...
	public static ArrayList<Resource> getAllTheEventsFromAPerson(String mail){
		//the name parameter will be the complete url 
		//Resource res = FollowyoureventTDB.getFollowyoureventTDB().getResource(mail);
